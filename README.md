...
I am more of a visual learner, so the different concepts in HTML and CSS were easier to learn for me. Since I already had some experience with HTML, I had a more solid foundation to stand on e.g. what terms to use when researching on my own. I also understood the information I came across (both online and on the course), faster.
